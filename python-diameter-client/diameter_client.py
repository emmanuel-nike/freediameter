...
class DiameterClient:
    ...
    def send_cer(self, connection=None):
        ...
        cer_avps.append(encodeAVP('Supported-Vendor-Id', diameter_base.standard_avp_values['Supported-Vendor-Id']))
        cer_avps.append(encodeAVP('Auth-Application-Id', DIAMETER_APPLICATION_CREDIT_CONTROL))
        cer_avps.append(encodeAVP('Inband-Security-Id', DI_INBAND_SECURITY_ID_NO_INBAND_SECURITY))
        cer_avps.append(encodeAVP('Firmware-Revision', 0))
        cer_avps.append(encodeAVP('Vendor-Specific-Application-Id', [
            encodeAVP('Vendor-Id', diameter_base.standard_avp_values['Vendor-Id']),
            encodeAVP('Auth-Application-Id', 16777223)
        ]))
        cer_avps.append(encodeAVP('Vendor-Specific-Application-Id', [
            encodeAVP('Vendor-Id', diameter_base.standard_avp_values['Vendor-Id']),
            encodeAVP('Auth-Application-Id', 16777238) 
        ]))
        cer_avps.append(encodeAVP('Vendor-Specific-Application-Id', [
            encodeAVP('Vendor-Id', diameter_base.standard_avp_values['Vendor-Id']),
            encodeAVP('Auth-Application-Id', 16777266) 
        ]))
        cer_avps.append(encodeAVP('Vendor-Specific-Application-Id', [
            encodeAVP('Vendor-Id', diameter_base.standard_avp_values['Vendor-Id']),
            encodeAVP('Auth-Application-Id', 16777272) 
        ]))
        #cer_avps.append(encodeAVP('Service-Context-Id', 'cc_test@example.net'))
